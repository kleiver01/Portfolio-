...
const App = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-950 to-black text-white flex flex-col md:flex-row items-center justify-center p-8 font-sans relative overflow-hidden">
      {/* Fondo con partículas o efectos visuales */}
      ...
      <style>{`
        ...
        .animate-typing { animation: typing 3s steps(40, end), blink-caret .75s step-end infinite; }
        ...
        /* Animación para el hover del contenido principal */
        .group:hover > div {
      ...
      <div className="relative z-10 md:mr-16 mb-12 md:mb-0">
        <PortfolioMenu currentPage={currentPage} setCurrentPage={setCurrentPage} />
      </div>
      <div className="relative z-10 flex-1 w-full max-w-4xl group"> {/* Agregado 'group' aquí */}
        {renderPage()}
      </div>
    </div>
  );
